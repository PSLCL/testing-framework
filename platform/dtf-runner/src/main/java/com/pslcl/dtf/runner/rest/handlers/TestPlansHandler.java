...
public final class TestPlansHandler implements Handler<RoutingContext>
{
    ...
    public void handle(RoutingContext context)
    {
        ...
        switch(endpoint.endpoint)
        {
            ...
            case Tests:
                ...
                break;
            case Test:
                getTest(context, endpoint.planId);
                break;
            case Unknown:
    ...
    {
        VertxUtil.errorResponse(context, HttpStatus.INTERNAL_SERVER_ERROR, ErrorCodes.INTERNAL_SERVER_ERROR, "Not implemented yet: " + context.request().method());
    }

    private void getTest(RoutingContext context, String planId)
    {
        VertxUtil.errorResponse(context, HttpStatus.INTERNAL_SERVER_ERROR, ErrorCodes.INTERNAL_SERVER_ERROR, "Not implemented yet: " + context.request().method());
    }
...
//                return new ModulesHandler.ModuleEndpoint(moduleId, Artifacts);
//            if(remainder.equals(RestServiceInstance.Report))
//                return new ModulesHandler.ModuleEndpoint(moduleId, Report);
