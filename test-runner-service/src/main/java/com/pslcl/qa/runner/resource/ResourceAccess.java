...
public class ResourceAccess implements ResourceProvider {
    ...
    public ResourceInstance bind(ResourceWithAttributes resourceWithAttributes) throws ResourceNotFoundException {
        ...
        System.out.println("ResourceAccess.bind() called with resourceHash/resourceAttributes: " + resourceWithAttributes.getHash() + " / " + resourceWithAttributes.getAttributes());
    ...
    public List<? extends ResourceInstance> bind(List<? extends ResourceWithAttributes> resources) {
        ...
        for(int i=0; i<resources.size(); i++) {
            try {
                ...
                retRiList.add(null);
                System.out.println("ResourceAccess.bind(List<> resources) stores null entry");
            }
        }
        return retRiList;
    }
    ...
    public ResourceQueryResult reserveIfAvailable(List<ResourceWithAttributes> resources, int timeoutSeconds) {
        ResourceQueryResult retRqr = null;
        ...
        retRqr = resourceProviders.reserve(resources, timeoutSeconds);
    ...
    public List<String> getHashes() {
        // ResourceAccess does not supply hashes, attributes or descriptions.
        return null;
    }
